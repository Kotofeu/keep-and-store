...
export const Notepad: FC<IconProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    <path
      d="M20.6667 24H3.33333C2.59667 24 2 23.4492 2 22.7692V15.3845H22V22.7692C22 23.4492 21.4033 24 20.6667 24Z"
      fill="url(#catalog-gradient-1)"
    />
    <path
      d="M20.6667 22.1541H3.33333C2.59667 22.1541 2 21.6033 2 20.9233V14.1541H22V20.9233C22 21.6033 21.4033 22.1541 20.6667 22.1541Z"
      fill="url(#catalog-gradient-2)"
    />
    <path
      d="M20.6667 20.3075H3.33333C2.59667 20.3075 2 19.7568 2 19.0768V2.46125C2 1.78124 2.59667 1.23047 3.33333 1.23047H20.6667C21.4033 1.23047 22 1.78124 22 2.46125V19.0768C22 19.7568 21.4033 20.3075 20.6667 20.3075Z"
      fill="url(#catalog-gradient-3)"
    />
    <path
      d="M19 9.23118H4.99996C4.81596 9.23118 4.66663 9.09333 4.66663 8.92348V7.6927C4.66663 7.52286 4.81596 7.38501 4.99996 7.38501H19C19.184 7.38501 19.3333 7.52286 19.3333 7.6927V8.92348C19.3333 9.09333 19.184 9.23118 19 9.23118Z"
      fill="#3B3B3B"
    />
    <path
      d="M19 12.9231H4.99996C4.81596 12.9231 4.66663 12.7852 4.66663 12.6154V11.3846C4.66663 11.2148 4.81596 11.0769 4.99996 11.0769H19C19.184 11.0769 19.3333 11.2148 19.3333 11.3846V12.6154C19.3333 12.7852 19.184 12.9231 19 12.9231Z"
      fill="#3B3B3B"
    />
    <path
      d="M19 16.6155H4.99996C4.81596 16.6155 4.66663 16.4776 4.66663 16.3078V15.077C4.66663 14.9071 4.81596 14.7693 4.99996 14.7693H19C19.184 14.7693 19.3333 14.9071 19.3333 15.077V16.3078C19.3333 16.4776 19.184 16.6155 19 16.6155Z"
      fill="#3B3B3B"
    />
    <path
      d="M19.0001 3.07695C18.4481 3.07695 18.0001 2.6634 18.0001 2.15386V0.923084C18.0001 0.413542 18.4481 0 19.0001 0C19.5521 0 20.0001 0.413542 20.0001 0.923084V2.15386C20.0001 2.6634 19.5521 3.07695 19.0001 3.07695Z"
      fill="#3B3B3B"
    />
    <path
      d="M14.3334 3.07695C13.7814 3.07695 13.3334 2.6634 13.3334 2.15386V0.923084C13.3334 0.413542 13.7814 0 14.3334 0C14.8854 0 15.3334 0.413542 15.3334 0.923084V2.15386C15.3334 2.6634 14.8854 3.07695 14.3334 3.07695Z"
      fill="#3B3B3B"
    />
    <path
      d="M9.66681 3.07695C9.11481 3.07695 8.66681 2.6634 8.66681 2.15386V0.923084C8.66681 0.413542 9.11481 0 9.66681 0C10.2188 0 10.6668 0.413542 10.6668 0.923084V2.15386C10.6668 2.6634 10.2188 3.07695 9.66681 3.07695Z"
      fill="#3B3B3B"
    />
    <path
      d="M5.00006 3.07695C4.44806 3.07695 4.00006 2.6634 4.00006 2.15386V0.923084C4.00006 0.413542 4.44806 0 5.00006 0C5.55206 0 6.00006 0.413542 6.00006 0.923084V2.15386C6.00006 2.6634 5.55206 3.07695 5.00006 3.07695Z"
      fill="#3B3B3B"
    />
    <defs>
      <linearGradient id="catalog-gradient-1" x1="12" y1="19.6516" x2="12" y2="23.035" gradientUnits="userSpaceOnUse">
        <stop offset="0.435" stopColor="#382010" />
        <stop offset="1" stopColor="#B0622B" />
      </linearGradient>
      <linearGradient id="catalog-gradient-2" x1="12" y1="18.1264" x2="12" y2="21.2686" gradientUnits="userSpaceOnUse">
      ...
      >
        ...
        <stop offset="1" stopColor="#F8F4E8" />
      </linearGradient>
    </defs>
  </svg>
);

export const Standard: FC<IconProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    <path
      xmlns="http://www.w3.org/2000/svg"
      d="M12.3287 0C7.0424 0 1 2.9724 1 11.3682C1 17.4648 5.69192 24 12.8697 24C12.8721 24 12.9735 24 12.9772 24C15.6726 23.9526 18.574 22.2492 18.574 18.6246C18.574 17.9304 18.309 17.3292 18.0767 16.7994C18.014 16.6596 17.9544 16.5222 17.8997 16.383C17.3686 15.078 17.9544 14.6004 19.3313 13.644C20.8907 12.5604 23.0274 11.0772 22.9997 7.1526C22.9997 4.8192 20.3916 0 12.3287 0ZM12.673 21.12C11.2954 21.12 10.2136 20.064 10.2136 18.7206C10.2136 17.376 11.2954 16.32 12.673 16.32C14.0486 16.32 15.1305 17.376 15.1305 18.7206C15.1305 20.064 14.0492 21.12 12.673 21.12Z"
      fill="#F3F4F6"
    />
    <path
      d="M18.3902 5.40015C17.202 5.40015 16.2388 6.34035 16.2388 7.50015C16.2388 8.65995 17.202 9.60015 18.3902 9.60015C19.5784 9.60015 20.5417 8.65995 20.5417 7.50015C20.5417 6.34035 19.5784 5.40015 18.3902 5.40015Z"
      fill="#9C27B0"
    />
    <path
      d="M12.858 1.80005C11.6698 1.80005 10.7066 2.74025 10.7066 3.90005C10.7066 5.05985 11.6698 6.00005 12.858 6.00005C14.0462 6.00005 15.0094 5.05985 15.0094 3.90005C15.0094 2.74025 14.0462 1.80005 12.858 1.80005Z"
      fill="#2196F3"
    />
    <path
      d="M6.71111 4.80005C5.52291 4.80005 4.55969 5.74025 4.55969 6.90005C4.55969 8.05985 5.52291 9.00005 6.71111 9.00005C7.8993 9.00005 8.86252 8.05985 8.86252 6.90005C8.86252 5.74025 7.8993 4.80005 6.71111 4.80005Z"
      fill="#4CAF50"
    />
    <path
      d="M6.09636 11.4001C4.90816 11.4001 3.94495 12.3403 3.94495 13.5001C3.94495 14.6599 4.90816 15.6001 6.09636 15.6001C7.28455 15.6001 8.24777 14.6599 8.24777 13.5001C8.24777 12.3403 7.28455 11.4001 6.09636 11.4001Z"
      fill="#FF3D00"
    />
  </svg>
);
